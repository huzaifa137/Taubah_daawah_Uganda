            ...
            <div class="container">
                <div class="banner-header">
                    ...
                    <?php 
                     ...
                     $dt = Carbon::now();
                     $dt->addDays(1);
                    echo "<p style='color:green;'>" . $dt->toHijri()->isoFormat('LL') . " A.H.". "</p>" ;
                    ?>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="company-detail bg-light margin-right">
                                                            ...
                                                            <p style="text-align: justify">Taubah Daawah Uganda is making such material available in our effort to advance understanding of Islam and Prophetic teachings among the Muslim brothers and sisters we do not own nor create some of this content.</p>
